...
/** Grows as packs land: code / space / fantasy still to come. */
export type ThemeName = 'classic' | 'animals' | 'food';
...
export const THEME_ORDER: readonly ThemeName[] = ['classic', 'animals', 'food'];
